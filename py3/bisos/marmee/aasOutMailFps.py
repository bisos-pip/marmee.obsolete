...
** Invoked class's static method.
    ...
    AasOutMail_FPs.fps_asCsParamsAdd(csParams,)


####+BEGIN: bx:dblock:python:class :className "AasOutMail_FPs" :superClass "bpoFpsCls.BpoFpsCls" :comment "" :classType "basic"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Cls-basic  [[elisp:(outline-show-subtree+toggle)][||]] /AasOutMail_FPs/ bpoFpsCls.BpoFpsCls  [[elisp:(org-cycle)][| ]]
#+end_org """
class AasOutMail_FPs(bpoFpsCls.BpoFpsCls):
####+END:
    """
...
####+BEGIN: b:py3:cs:cmnd/classHead :cmndName "marmeeAasOutMail_fps" :comment "" :extent "verify" :parsMand "bpoId envRelPath" :argsMin 1 :argsMax 9999 :pyInv ""
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  CmndSvc-   [[elisp:(outline-show-subtree+toggle)][||]] <<marmeeAasOutMail_fps>>  =verify= parsMand=bpoId envRelPath argsMin=1 argsMax=9999 ro=cli   [[elisp:(org-cycle)][| ]]
#+end_org """
class marmeeAasOutMail_fps(cs.Cmnd):
...
** [[elisp:(org-cycle)][| *CmndDesc:* | ]]  A starting point command.
        ...
        basedFps = b.pattern.sameInstance(AasOutMail_FPs, bpoId, envRelPath)

        fpsBase = basedFps.basePath_obtain()

        if action == "list":
            print(f"With fpBase={fpsBase} and cls={AasOutMail_FPs} name={basedFps.__class__.__name__}.")
            ...
            print(f"With fpBase={fpsBase} and cls={AasOutMail_FPs} NOTYET.")
        else:
