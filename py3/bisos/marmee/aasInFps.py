...
** --rosmu (Remote Operations Service Unit. Name of the ROS)
    ...
    AasIn_accessFPs.fps_asIcmParamsAdd(icmParams,)


####+BEGIN: bx:dblock:python:class :className "AasIn_accessFPs" :superClass "bpo.bpoFpsCls.BpoFpsCls" :comment "" :classType "basic"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Cls-basic  [[elisp:(outline-show-subtree+toggle)][||]] /AasIn_accessFPs/ bpo.bpoFpsCls.BpoFpsCls  [[elisp:(org-cycle)][| ]]
#+end_org """
